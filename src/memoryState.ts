...
export type MemoryNodeTier = 'core' | 'connection' | 'leaf'
...
export const initialMemoryGraph: MemoryGraphData = {
  nodes: [
    { id: 'context-brief', layer: 'context', source: 'dingtalk', title: '本周产品节奏', summary: '需要推进发布准备与关键判断。', tier: 'core' },
    { id: 'context-roadmap', layer: 'context', source: 'feishu', title: '产品路线图', summary: '已确认的阶段目标与优先级。', tier: 'connection' },
    { id: 'context-team', layer: 'context', source: 'teams', title: '协作分工', summary: '团队当前的职责与配合方式。', tier: 'connection' },
    { id: 'context-research', layer: 'context', source: 'file', title: '用户研究摘要', summary: '访谈结论与待验证的问题。', tier: 'leaf' },
    { id: 'context-followup', layer: 'context', source: 'conversation', title: '项目跟进', summary: '工作对话中形成的下一步。', tier: 'connection' },
    { id: 'context-release', layer: 'context', source: 'dingtalk', title: '发布准备', summary: '需要同步的发布事项。', tier: 'leaf' },
    { id: 'context-planning', layer: 'context', source: 'feishu', title: '季度规划', summary: '正在讨论的工作重点。', tier: 'leaf' },
    { id: 'context-review', layer: 'context', source: 'teams', title: '评审记录', summary: '跨团队评审中的明确结论。', tier: 'leaf' },
    { id: 'context-briefing', layer: 'context', source: 'file', title: '项目背景', summary: '工作资料中的项目上下文。', tier: 'leaf' },
    { id: 'context-decisions', layer: 'context', source: 'conversation', title: '已确认决策', summary: '日常沟通里明确的选择。', tier: 'leaf' },
    { id: 'user-direction', layer: 'user', source: 'dingtalk', title: '产品判断优先', summary: '优先确认用户价值与关键取舍。', tier: 'core' },
    { id: 'user-collaboration', layer: 'user', source: 'feishu', title: '协作方式', summary: '偏好清晰的结论与下一步。', tier: 'connection' },
    { id: 'user-context', layer: 'user', source: 'file', title: '工作背景', summary: '长期有效的项目与职责。', tier: 'leaf' },
    { id: 'user-followup', layer: 'user', source: 'conversation', title: '跟进偏好', summary: '将讨论沉淀为可执行事项。', tier: 'leaf' },
  ],
  edges: [
