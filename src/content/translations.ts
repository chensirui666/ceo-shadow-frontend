...
type OnboardingCopy = {
  ...
  style: { title: string; subtitle: string; summary: string; points: string[]; extract: string; view: string; start: string; extractingTitle: string; extractingSubtitle: string; analysis: string; analysisComplete: string; editHint: string; promptLabel: string; usePrompt: string; prompt: string }
