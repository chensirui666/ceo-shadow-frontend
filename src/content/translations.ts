...
type OnboardingCopy = {
  ...
  memory: { title: string; subtitle: string; connectedTitle: string; connected: string; readOnly: string; signalsTitle: string; signals: Record<'messages' | 'documents' | 'calendar', [string, string]>; demo: string; confirm: string; view: string; skip: string; proceed: string; readingTitle: string; reading: [string, string]; summary: string; construct: string; building: string }
  ...
  zh: {
    ...
    workspace: {
      ...
      onboarding: {
        ...
        memory: { title: '建立你的 Memory', subtitle: '先确认 Friday 将读取的范围，再建立第一份工作 Memory。', connectedTitle: '已连接的应用', connected: '已连接', readOnly: '只读', signalsTitle: 'Friday 会读取什么', signals: { messages: ['工作消息', '对话、决策与待办'], documents: ['工作文档', '项目背景与关键结论'], calendar: ['日历信息', '会议、事件与时间安排'] }, demo: '仅为本地演示：不会读取已连接应用的内容，也不会写入真实 Memory。', confirm: '建立 Memory', view: '查看 Memory', skip: 'Skip', proceed: '确认', readingTitle: '正在读取已连接的工作信息', reading: ['正在读取近期工作消息…', '正在整理文档与会议上下文…'], summary: '已整理 126 条工作消息、18 份文档，以及 7 个反复出现的工作主题，可用于构造第一份 Memory。', construct: '开始构造 Memory', building: '正在构造本地 Memory 预览…' },
