...
test('a negative owner card and detail stay source-labelled and read-only', async () => {
  ...
  const cardsHtml = renderToStaticMarkup(createElement(FeedbackCardWall, { copy: translations.zh.workspace.feedback, items: [card], locale: 'zh', onOpen: () => {} }))
