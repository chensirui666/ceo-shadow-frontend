...
- The editable Prompt is held in component state for the current onboarding visit. Confirming the work style uses that edited value as the session's confirmed style; it is not persisted or sent outside the demo.
